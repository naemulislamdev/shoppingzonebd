...
<div class="content container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h3 mb-0 text-black-50">{{\App\CPU\translate('Customer')}} {{\App\CPU\translate('leads')}} {{\App\CPU\translate('List')}}</h1>
    </div>
                ...
                <div class="card-header">
                    ...
                    <div class="row justify-content-between align-items-center flex-grow-1">
                        <div class="flex-start col-lg-3 mb-3 mb-lg-0">
                            <h5>{{\App\CPU\translate('Customer')}} {{\App\CPU\translate('Leads')}} {{\App\CPU\translate('table')}} </h5>
                            <h5 style="color: red; margin-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}: 5px">({{ $leads->total() }})</h5>
                        </div>
                        <div class="col-lg-2">
                            Export :
