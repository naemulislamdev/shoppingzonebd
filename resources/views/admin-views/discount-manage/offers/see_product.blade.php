...
@section('title', \App\CPU\translate('Products in Discount Offers'))
@push('css_or_js')
        ...
        <div class="d-flex justify-content-between mb-2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">{{ \App\CPU\translate(' Discount Offers Product') }}</li>
                </ol>
            </nav>
                    ...
                    <div class="card-header">
                        <div class="flex-between row justify-content-between align-items-center flex-grow-1 mx-1">
                            <div class="flex-between">
                                <div>
                                    <h5>{{ \App\CPU\translate('Discount Offers Product Table') }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-danger btn-sm"
                                                    href="{{ route('admin.discount.discount-offers.remove.product', $product->id) }}">
