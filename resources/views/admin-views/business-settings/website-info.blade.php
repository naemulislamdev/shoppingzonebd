        ...
        <div
            ...
            <form action="{{ route('admin.business-settings.update-info') }}" method="POST"
                ...
                <div class="row" style="padding-bottom: 20px">
                    ...
                    <div class="col-md-4">
                        @php($company_hotline=\App\Model\BusinessSetting::where('type','company_hotline')->first())
                        <div class="form-group">
                            <label class="input-label">{{\App\CPU\translate('Company hotline')}}</label>
                            <input class="form-control" type="text" name="company_hotline"
                                   value="{{ $company_hotline->value?$company_hotline->value:"" }}"
                                   placeholder="New Hotline">
                        </div>
                    </div>
