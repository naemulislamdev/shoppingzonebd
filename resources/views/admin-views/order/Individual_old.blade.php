            ...
            <div class="table-responsive datatable-custom">
                <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                    ...
                    <tr>
                        ...
                        <th>{{\App\CPU\translate('sell Price')}}</th>
                        <th>{{\App\CPU\translate('QUANTITY')}}</th>
                        <th>{{\App\CPU\translate('product AMOUNTS')}}</th>
                    ...
                    @foreach($OrderDetails as $key=>$order)
                        ...
                        <tr class="status-{{$order['order_status']}} class-all">
                            ...
                            <td >
                                <a href="{{route('admin.orders.details',['id'=>$order['id']])}}">{{$order['order_id']}}</a>
                            </td>
                            <td>{{date('d M Y',strtotime($order['created_at']))}}</td>
                            <!--<td>-->
                            <!--    @if($order->customer)-->
                            <!--        <a class="text-body text-capitalize"-->
                            <!--           href="{{route('admin.orders.details',['id'=>$order['id']])}}">{{$order->order['customer']['f_name'].' '.$order->order['customer']['f_name']}}</a>-->
                            <!--    @else-->
                            ...
                            <td>{{$order->name}}</td>
                            <td>{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($order->purchase_price))}}</td>
                            ...
                            <td>{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($order->price-$order->discount))}}</td>
                            <td>{{$order->qty}}</td>
                            <td>{{\App\CPU\BackEndHelper::set_symbol((($order->price-$order->discount)*$order->qty))}}</td>
