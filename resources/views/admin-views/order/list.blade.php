    ...
    <div class="content container-fluid">
        ...
        <div class="page-header mb-1">
            <div class="flex-between align-items-center">
                <div>
                    <span class="h1"> <span class="page-header-title">{{ ucwords(str_replace('_', ' ', $status)) }}</span>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                                    ...
                                    <div class="flex-between align-items-center mb-1">
                                        <div
                                            ...
                                            <span class="card-title h2" style="color: #F14A16!important;">
                                                {{ \App\Model\Order::when(
                                                    session()->has('show_inhouse_orders') && session('show_inhouse_orders') == 1,
                                                    function ($q) {
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                            <!-- Card -->
                            <a class="card card-hover-shadow h-100" href="{{ route('admin.orders.list', ['confirmed']) }}"
                                style="background: #FFFFFF;">
                                <div class="card-body">
                                    <div class="flex-between align-items-center mb-1">
                                        <div
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                            <!-- Card -->
                            <a class="card card-hover-shadow h-100" href="{{ route('admin.orders.list', ['processing']) }}"
                                style="background: #FFFFFF">
                                <div class="card-body">
                                    <div class="flex-between align-items-center gx-2 mb-1">
                                        <div
                                            style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};">
                                            <h6 class="card-subtitle" style="color: #F14A16!important;">
                                                {{ \App\CPU\translate('Processing') }}</h6>
                                            <span class="card-title h2" style="color: #F14A16!important;">
                                                {{ \App\Model\Order::when(
                                                    session()->has('show_inhouse_orders') && session('show_inhouse_orders') == 1,
                                                    function ($q) {
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                            ...
                            <a class="card card-hover-shadow h-100"
                                href="{{ route('admin.orders.list', ['out_for_delivery']) }}" style="background: #FFFFFFff">
                                <div class="card-body">
                                    <div class="flex-between align-items-center gx-2 mb-1">
                                        <div
                                            style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};">
                                            <h6 class="card-subtitle" style="color: #F14A16!important;">
                                                {{ \App\CPU\translate('out_for_delivery') }}</h6>
                                            <span class="card-title h2" style="color: #F14A16!important;">
                                                {{ \App\Model\Order::when(
                                                    session()->has('show_inhouse_orders') && session('show_inhouse_orders') == 1,
                                                    function ($q) {
            ...
            <div class="card mt-2 ">
                <div>
                    <h2 class="h4 ml-3 mt-4">{{ \App\CPU\translate('payment') }} {{ \App\CPU\translate('status') }}</h2>
                    <br>
                </div>
        ...
        <div class="card">
                        ...
                        <div class="float-right">
                            ...
                            <label class="switch ml-3">
                                <input type="checkbox" class="status" onclick="filter_order()"
                                    {{ session()->has('show_inhouse_orders') && session('show_inhouse_orders') == 1 ? 'checked' : '' }}>
            ...
            <!-- End Header -->
            <!-- Table -->
            <table id="example" class="display p-3" style="width:100%">
                ...
                <tbody>
                    ...
                    @php
                        $sumTotal = $sumTotal + $order->order_amount;
                    @endphp
                        <tr class="status-{{ $order['order_status'] }} class-all">
                            ...
                            <td>
                                @if ($order->customer)
                                    <a class="text-body text-capitalize"
                                        href="{{ route('admin.orders.details', ['id' => $order['id']]) }}">{{ $order->customer['phone'] }}</a>
                                @else
                                    <label
                                        class="badge badge-danger">{{ \App\CPU\translate('invalid_customer_data') }}</label>
                                @endif
                            ...
                            <td> {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($order->shipping_cost)) }}
                            </td>
                            <td> {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($order->order_amount + $order->shipping_cost)) }}
                            </td>
                            ...
                            <td>
                                ...
                                <a class="btn btn-primary btn-sm mr-1 mb-1" title="{{ \App\CPU\translate('edit') }}"
                                    href="{{ route('admin.orders.edit', ['id' => $order['id']]) }}"><i
                                        class="tio-edit"></i> </a>
                                <a class="btn btn-info btn-sm mr-1 mb-1" target="_blank"
                ...
                <tfoot>
                    <tr>
                        <th colspan="14">Total Amount:  {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($sumTotal)) }}</th>
                    </tr>
                </tfoot>
            </table>
            <!-- End Table -->
