                ...
                <div class="row">
                    <div class="col-12 col-md-6 mt-4">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                            data-target="#exampleModalCenterAdvance">
                            Advanced Payment
                        </button>
                        @if ($orderHistories->count() > 0)
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#exampleModalCenterHistory">
                                History
                            </button>
                        @endif

                        <!--Advance Payment Modal Start-->
                        <div class="modal fade" id="exampleModalCenterAdvance" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle">Invoice Id #{{ $order['id'] }}
                                        </h5>
                                    ...
                                    <form class="form-horizontal"
                                        action="{{ route('admin.orders.advance-payment', $order->id) }}" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="advance_payment_method"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" placeholder="Advance Payment"
                                                            type="number" value="" name="advance_payment">
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <!--History Modal Start-->
                        <div class="modal fade" id="exampleModalCenterHistory" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle">Invoice Id
                                            #{{ $order['id'] }}</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                        ...
                                        <table>
                                            ...
                                            @foreach ($orderHistories as $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        Order : {{ json_decode($value->details)->order }}, Discount:
                                                        {{ json_decode($value->details)->discount }}
                        ...
                        @if ($detail->product)
                                    ...
                                    @if (isset($shop))
                                        <div class="row">
                                            <img class="avatar-img" style="width: 55px;height: 55px; border-radius: 50%;"
                                                onerror="this.src='{{ asset('assets/front-end/img/image-place-holder.png') }}'"
                                                src="{{ asset('storage/shop/' . $shop->image) }}" alt="Image">
                                            <p class="sellerName">
                                                <a style="color: black;"
                                ...
                                <div class="media-body">
                                    <div class="row">
                                        <div class="col-md-4 mb-3 mb-md-0 product-name">
                                            ...
                                            <p><b>Code: {{ $detail->product->code }}</b></p>
                                            <strong><u>{{ \App\CPU\translate('Variation') }} : </u></strong>

                                            <div class="font-size-sm text-body">

                                                <span
                                                    class="font-weight-bold">{{ $detail['variant'] }}-{{ $detail['variation'] }}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col col-md-2 align-self-center  p-0 product-name">
                                            ...
                                            <a class="btn btn-primary" data-toggle="modal"
                                                href="{{ route('admin.orders.detailsProduct', $detail['id']) }}"
                            ...
                            <div class="modal fade" id="exampleModal{{ $detail->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel{{ $detail['id'] }}"> Change
                                                Discount/Quantity ( <small>{{ $detail->product['name'] }}</small> )</h5>
                                        ...
                                        <form class="form-horizontal"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        DISCOUNT: <input class="form-control"
                                                            placeholder="Add or Edit Discount" type="number"
                                                            value="{{ \App\CPU\Convert::default(@$detail->discount) }}"
                                                            name="discount" id="discount">
                                                    </div>
                                                    <div class="col-md-6">
                                                        Quantity: <input class="form-control"
                                                            placeholder="Add or Edit qty" type="number"
                                                            value="{{ @$detail->qty }}" name="qty" id="qty">
                                                    </div>
                                                </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control text-capitalize js-select2-custom"
                                            name="delivery_service_name" required>
                                            <option value="0">{{ \App\CPU\translate('select') }}</option>
                                            @foreach ($curiers as $value)
                                                <option value="{{ $value['name'] }}"
                                                    {{ $order['delivery_service_name'] == $value['name'] ? 'name' : '' }}>
...
@push('script_2')
        ...
        function order_status(status) {
            ...
            if (status === 'delivered') {
                Swal.fire({
                    ...
                    html: '<br /> <form class="form-horizontal" action="{{ route('admin.orders.status') }}" method="post"><input type="hidden" name="order_status" value="' +
                        status +
    ...
    <script>
        function initializegLocationMap() {
            var map = null;
            var myLatlng = new google.maps.LatLng({{ @$shipping_address->latitude }},
