...
@section('title', \App\CPU\translate('Canceled User-info List'))
@push('css_or_js')
    ...
    <div class="content container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{ \App\CPU\translate('Canceled_user_info') }}</li>
            </ol>
        </nav>
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0 text-black-50">{{ \App\CPU\translate('canceled_user-info') }}
                {{ \App\CPU\translate('List') }} <span class="badge badge-soft-danger">{{ \App\Models\UserInfo::where("order_status", 'canceled')->count() }}</span></h1>
    ...
    <script>
        ...
        $(function() {
            let usertable = $('#userinfos-table').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.user-info.canceled') }}',
                    data: function(d) {
