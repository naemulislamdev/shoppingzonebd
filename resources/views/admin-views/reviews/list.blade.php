                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <button id="filter" type="submit" class="btn btn-primary btn-block filter"><i
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <a href="{{ route('admin.reviews.export', ['product_id' => $product_id, 'customer_id' => $customer_id, 'status' => $status, 'from' => $from, 'to' => $to]) }}"
                                class="btn btn-block btn-info text-capitalize font-weight-bold export" data-toggle="tooltip"
