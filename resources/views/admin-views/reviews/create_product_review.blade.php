    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">{{ \App\CPU\translate('Create Product Review') }}</h5>
                <h6 class="card-subtitle text-muted">{{ \App\CPU\translate('You can create a product review from here') }}
                </h6>
                <a href="{{ route('admin.reviews.list') }}" class="btn btn-primary">{{ \App\CPU\translate('Back') }}</a>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.reviews.create.product.store') }}" method="POST">
                    @csrf
                    <div class="form-group">
                        ...
                        <select name="product_id" id="product_id" class="form-control js-select2-custom">
                            <option value="">{{ \App\CPU\translate('Select Product') }}</option>
                    ...
                    <div class="form-group">
                        <label for="customer_id">{{ \App\CPU\translate('Customer Name') }}</label>
