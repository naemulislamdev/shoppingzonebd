        ...
        <div
            ...
            <div
                ...
                <img
                    ...
                    onerror="this.src='{{asset('assets/front-end/img/human-icon.jpg')}}'"
                    src="{{asset("storage/profile")}}/{{(isset($productReview->user)?$productReview->user->image:'')}}"
                    alt="{{isset($productReview->user)?$productReview->user->f_name: $productReview->customer_name}}"/>
                <div
                    class="media-body {{Session::get('direction') === "rtl" ? 'pr-3' : 'pl-3'}} text-body">
                     <span class="font-size-sm mb-0 text-body" style="font-weight: 700;font-size: 12px;">
                            @if ($productReview->customer_id != null)
