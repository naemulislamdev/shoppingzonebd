...
@section('content')
                                ...
                                <div class="media-body pt-2">
                                    ...
                                    @if ($product['variation'])
                                        @foreach (json_decode($product['variation'], true) as $key1 => $variation)
                                            <div class="text-muted"><span class="mr-2">{{ $key1 }} :</span>
                                                @if ($product['variation'])
                                                    @foreach (json_decode($product['variation'], true) as $key1 => $variation)
                                                        <div class="text-muted">
                                                            <span class="mr-2">{{ $key1 }} :</span>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent px-0 mb-2">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('track-order.index') }}" class="breadcrumb-link">
                        Order Track
                    </a>
                </li>
    ...
    <div class="container ">
        ...
        <div class=" ">
            <h2 class="text-center" style="color: #f26d21">{{ \App\CPU\translate('Your Order') }}</h2>
        </div>
        <div style="background: #f26d21" class="rounded-top">
    ...
    <div class="container mb-md-3 ">
        ...
        <div class="row" style="background: #e2f0ff; margin: 0; width: 100%;">
            ...
            <div class="col-sm-4">
                <div class="pt-2 pb-2 text-center rounded-lg">
                    <span class="font-weight-medium text-dark mr-2">{{ \App\CPU\translate('Payment Status') }}:</span>
                    <br>
            ...
            <div class="card-body pb-2">
                <ul class="nav nav-tabs media-tabs nav-justified">
                    @if ($orderDetails['order_status'] != 'returned' && $orderDetails['order_status'] != 'failed')
                        ...
                        <li class="nav-item">
                            <div class="nav-link">
                                <div class="align-items-center progrss-card">
        ...
        <div class="d-sm-flex flex-wrap justify-content-between align-items-center text-center pt-3">
            ...
            <a class="btn btn-info btn-sm mt-2 mb-2" href="#order-details" data-toggle="modal"><i class="fa fa-eye"
                    aria-hidden="true"></i> {{ \App\CPU\translate('View Order Details') }}</a>
        </div>
    </div>
