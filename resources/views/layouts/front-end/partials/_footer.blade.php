        ...
        <div class="row">
            <div class="col-md-3">
                <div class="footer-title">
                    ...
                    <img class="footer-logo" src="{{ asset('storage/company/') }}/{{ $web_config['footer_logo']->value }}"
                    ...
                    <ul>
                        ...
                        <li><i class="fa fa-envelope"></i><a
                                href="mailto:{{ $company_email }}">{{ \App\CPU\translate('Email') }}:
                                {{ $company_email }}</a></li>
            ...
            <div class="col-md-3">
                <div class="footer-title">
                    ...
                    <ul>
                        <li><a
                                href="@if (auth('customer')->check()) {{ route('user-account') }} @else {{ route('customer.auth.login') }} @endif">{{ \App\CPU\translate('Profile info') }}</a>
                        </li>
                        <li><a href="{{ route('wishlists') }}">{{ \App\CPU\translate('Wish List') }}</a></li>
                        <li><a
                                href="@if (auth('customer')->check()) {{ route('account-oder') }} @else {{ route('customer.auth.login') }} @endif">{{ \App\CPU\translate('Order History') }}</a>
                        </li>
        ...
        <div class="row py-3">
            <div class="col-md-12">
                <div class="copyright-text text-center">
                    <p class="mb-0 pb-0">
                        {{ \App\CPU\translate('Copyright © 2025 - Shopping Zone BD All Rights Reserved. Desing &') }}
                        <a target="_blank"
